...
export default function Help() {
  return (
    <div className='px-4 sm:px-14 md:px-20 lg:px-20 xl:px-32 py-4 sm:bg-[url("/images/dotted-background.svg")] bg-no-repeat'>
      <div className='space-y-5'>
        ...
        <div>
          <div className='flex items-center justify-between mb-2'>
            ...
            <div
              role='button'
              className='flex items-center space-x-1 text-[14px] text-xs sm:text-sm'
            >
