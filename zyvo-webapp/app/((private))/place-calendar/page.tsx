            ...
            <div className="w-full sm:w-[80%] flex flex-col gap-7 sm:order-1">
                ...
                <div className="flex gap-1 w-full">
                    <div className="grid grid-rows-1 text-black items-center gap-1">
                        {time.map((data, key) => {
                            return (
                                <div className=" text-[13px] font-normal font-Poppins bg-[#EFF2F5] h-[60px] w-[50px] rounded-xl flex text-center items-center">{data.val}</div>
                            )
                        })}
                    </div>
                    <div className="flex flex-col gap-1 w-full">
                        ...
                        <div className="grid grid-cols-7 text-black gap-1 w-full h-[60px]">
                            {date.map((data, key) => {
                                return (
                                    <div className=" text-[14px] font-normal font-Poppins bg-[#EFF2F5] h-full rounded-xl flex items-center justify-center">{data.val}</div>
                                )
                            })}
                        </div>
                        <div className="grid grid-cols-7 text-black gap-1 w-full">
                            {reminder.map((data, key) => {
                                return (
                                    <div className={`pl-1 font-Poppins border border-neutral-200 ${data.name ? "border-l-4 border-l-[#4AEAB1]" : "border-x"} h-[60px] rounded-xl flex justify-items-center justify-center flex-col overflow-hidden`}>
                                        <div className="text-[11px] font-bold ">{data.name}</div>
                                        <div className=" text-[9px] text-[#4AEAB1]">{data.reminder}</div>
