      ...
      {options.map((item, i) => {
        return (
          <div
            ...
            className={`xl:w-[50%] lg:w-[48%] w-[46%] h-[40px] items-center text-center justify-center flex py-2 xl:py-1 lg:py-1 md:py-1 sm:py-1 rounded-full text-sm md:text-base sm:text-base lg:text-md xl:text-[18px] ${
              item.value === selected
